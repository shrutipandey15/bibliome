...
EMOTIONS = [
    ...
    {"slug": "grief",       "family": FAMILY_HURT, "name": "grief",       "phrase": "it left a hole",           "symbol": "💧", "color": "#6B4F8E", "description": "Loss, absence, mourning — the ache"},
    {"slug": "dread",       "family": FAMILY_HURT, "name": "dread",       "phrase": "I couldn't relax",         "symbol": "😰", "color": "#4B6B8E", "description": "Anxiety, foreboding, existential unease"},
    {"slug": "rage",        "family": FAMILY_HURT, "name": "rage",        "phrase": "I was so angry",           "symbol": "⚡", "color": "#C44B4B", "description": "Fury, injustice, the urge to burn things down"},
    # It held me
    {"slug": "comfort",     "family": FAMILY_HELD, "name": "comfort",     "phrase": "it felt safe",             "symbol": "☕", "color": "#8E6B4B", "description": "Safety, warmth, being held by a book"},
    {"slug": "tenderness",  "family": FAMILY_HELD, "name": "tenderness",  "phrase": "it was gentle with me",    "symbol": "🌸", "color": "#9B6B7B", "description": "Gentle love, care, soft emotional moments"},
    ...
    # It wanted something
    {"slug": "longing",     "family": FAMILY_WANTED, "name": "longing",   "phrase": "I ached for it",           "symbol": "🕊", "color": "#5B6B8E", "description": "Distance, wanting what you cannot have"},
    {"slug": "desire",      "family": FAMILY_WANTED, "name": "desire",    "phrase": "the tension got me",       "symbol": "💜", "color": "#9B5B8E", "description": "Wanting, romantic tension, the pull toward"},
    ...
    # It moved me
    {"slug": "awe",         "family": FAMILY_MOVED, "name": "awe",         "phrase": "I had to stop and stare", "symbol": "🌟", "color": "#4B7B6B", "description": "Wonder, scale, the sublime"},
    {"slug": "recognition", "family": FAMILY_MOVED, "name": "recognition", "phrase": "how did it know",         "symbol": "🪞", "color": "#4B8E8A", "description": "Being seen — the book that knew you already"},
    {"slug": "catharsis",   "family": FAMILY_MOVED, "name": "catharsis",   "phrase": "I needed that cry",       "symbol": "✨", "color": "#C9A96E", "description": "Release, relief, the exhale after tension"},
    # It lost me
    ...
    {"slug": "revulsion",   "family": FAMILY_LOST, "name": "revulsion",     "phrase": "I couldn't stomach it",  "symbol": "🤢", "color": "#6B7A4B", "description": "Disgust, recoil, wanting to put it down"},
    {"slug": "confusion",   "family": FAMILY_LOST, "name": "confusion",     "phrase": "I lost the plot",        "symbol": "🌀", "color": "#7B6B9B", "description": "Lost the thread, couldn't follow, unmoored"},
    {"slug": "indifference","family": FAMILY_LOST, "name": "indifference",  "phrase": "nothing landed",         "symbol": "◻️", "color": "#9A9A9A", "description": "Nothing landed — you closed it and felt nothing"},
]
